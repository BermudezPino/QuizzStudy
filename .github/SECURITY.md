...
**Nota:** QuizzStudy es una copia de la versión original del proyecto (autor: Angel C.). Este repositorio es una versión derivada, adaptada y mantenida con fines educativos. La autoría y responsabilidad del proyecto original corresponden a su creador; esta política aplica a esta versión.
...
Si descubres una vulnerabilidad de seguridad en QuizzStudy, agradecemos tu colaboración para divulgarla de manera responsable. Por favor, sigue estos pasos:
...
- El código fuente de la aplicación QuizzStudy
...
Gracias por ayudarnos a mantener QuizzStudy segura para todos los usuarios.
