...
Los casos de comportamiento abusivo, acosador o inaceptable pueden ser informados contactando al equipo del proyecto en [juanitodiscord15@gmail.com](mailto:juanitodiscord15@gmail.com). Todas las quejas serán revisadas e investigadas y resultarán en una respuesta que se considere necesaria y apropiada a las circunstancias. El equipo del proyecto está obligado a mantener la confidencialidad respecto a la persona que reportó el incidente. Detalles específicos adicionales de políticas de aplicación pueden ser publicados por separado.
...
Como QuizzStudy es un proyecto educativo dentro de un contexto académico, también se aplican las siguientes consideraciones:
