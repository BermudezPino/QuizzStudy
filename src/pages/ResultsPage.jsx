...
import { addPreguntasFallidas, removePreguntasFallidas } from '@services/preguntasFallidasService';
import { calcularPuntuacion, formatAsignaturaNombreForDisplay, formatModuloNombreForDisplay } from '@utils/quizUtils';
...
export default function ResultsPage() {
  ...
  const breadcrumbs = [
    ...
    {
      label: formatModuloNombreForDisplay(modulo?.nombre) || 'Módulo',
  ...
  const pdfTitulo = `Resultados Quiz - ${formatAsignaturaNombreForDisplay(asignatura?.nombre) || 'Asignatura'} - ${formatModuloNombreForDisplay(modulo?.nombre) || 'Módulo'}`;
  ...
  return (
    <Layout>
      <PageHeader
        ...
        subtitle={`${formatAsignaturaNombreForDisplay(asignatura?.nombre)} - ${formatModuloNombreForDisplay(modulo?.nombre)}`}
