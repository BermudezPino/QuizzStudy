  ...
  return (
    <Layout>
      ...
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <Card className="mb-8">
          <h2 className="text-xl font-semibold mb-4 dark:text-white">Agradecimientos</h2>
          <p className="text-gray-700 dark:text-gray-200">
            Gracias a <strong className="text-gray-900 dark:text-white">Angel C.</strong>, autor original del proyecto, por crear y publicar la aplicación bajo licencia MIT. Sin su trabajo y su generosidad al compartir el código, esta versión no existiría. Le damos las gracias por el esfuerzo, el diseño y la base que hemos podido reutilizar y adaptar con fines educativos.
          </p>
        </Card>
        ...
        <Card className="mb-8">
            ...
            <ol className="list-decimal pl-6 space-y-3">
              ...
              <li>
                ...
                <div className="bg-gray-100 dark:bg-gray-800 p-2 mt-1 rounded font-mono text-sm text-gray-800 dark:text-gray-200">
                  git clone https://github.com/BermudezPino/QuizzStudy.git
                </div>
              </li>
              <li>
          ...
          <div className="mt-6">
            <a
              href="https://github.com/BermudezPino/QuizzStudy"
              target="_blank"
