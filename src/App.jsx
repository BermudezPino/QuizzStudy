...
function RouteErrorBoundary({ children }) {
  ...
  if (hasError) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-page dark:bg-gray-900">
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-page dark:bg-gray-900"><LoadingSpinner /></div>}>
              <RouteErrorBoundary>
                <ModulesPage />
              </RouteErrorBoundary>
            </Suspense>
