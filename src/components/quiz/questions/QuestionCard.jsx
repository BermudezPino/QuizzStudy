...
export default function QuestionCard({
  ...
  const renderRecurso = () => {
    ...
    switch (pregunta.recurso.tipo) {
      case 'imagen': {
        const src = pregunta.recurso.contenido;
        // Solo permitir rutas relativas (p. ej. /images/...) para evitar javascript: o data: maliciosos
        const isSafeSrc = typeof src === 'string' && src.startsWith('/') && !src.toLowerCase().startsWith('//');
