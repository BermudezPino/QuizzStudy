...
export default function Layout({ children }) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Añadimos padding-top solo en dispositivos móviles para compensar el header fijo. Fondo sage en claro (theme-page-bg.css + bg-page). */}
      <main
        className={`flex-grow bg-page dark:bg-gray-900 transition-colors duration-300 ${isMobile ? 'pt-16' : ''}`}
      >
        {children}
      </main>
