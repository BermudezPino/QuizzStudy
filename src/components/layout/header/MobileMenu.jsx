...
const MobileMenu = memo(function MobileMenu({ navItems, isHeaderVisible }) {
  ...
  return (
    <div className="md:hidden">
      ...
      <button
        onClick={toggleMenu}
        className="text-white p-2 rounded-md hover:bg-brand-800 dark:hover:bg-brand-700 focus:outline-none transition-colors duration-200 min-w-[44px] min-h-[44px] flex items-center justify-center"
