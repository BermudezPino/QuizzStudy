export const moduloTema4 = {
    id: 708,
    nombre: "Tema 4: Paso por referencia, sobrecarga y modularización",
    esExamen: false,
    asignaturaId: 7,
    descripcion: "Paso de parámetros por referencia, sobrecarga de métodos, modularización, métodos estáticos y Javadoc.",
    preguntas: [
        {
            id: 7741,
            moduloId: 708,
